...
Provides:       perl(Geometry::Primitive::Arc)
Provides:       perl(Geometry::Primitive::Bezier)
Provides:       perl(Geometry::Primitive::Circle)
Provides:       perl(Geometry::Primitive::Dimension)
Provides:       perl(Geometry::Primitive::Ellipse)
Provides:       perl(Geometry::Primitive::Equal)
Provides:       perl(Geometry::Primitive::Line)
Provides:       perl(Geometry::Primitive::Point)
Provides:       perl(Geometry::Primitive::Polygon)
Provides:       perl(Geometry::Primitive::Rectangle)
Provides:       perl(Geometry::Primitive::Shape)
...
%changelog
* Fri Apr 05 2024 Otto J Wittner <otto.wittner@sikt.no> 0.24-1
