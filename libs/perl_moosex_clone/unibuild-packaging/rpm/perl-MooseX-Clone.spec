...
Provides:       perl(MooseX::Clone::Meta::Attribute::Trait::Copy)
Provides:       perl(MooseX::Clone::Meta::Attribute::Trait::Clone)
Provides:       perl(MooseX::Clone::Meta::Attribute::Trait::NoClone)
Provides:       perl(MooseX::Clone::Meta::Attribute::Trait::Clone::Std)
Provides:       perl(MooseX::Clone::Meta::Attribute::Trait::Clone::Base)
